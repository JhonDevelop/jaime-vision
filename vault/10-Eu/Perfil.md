...
- Fundador da BUB (Build Up Better) — marketplace que conecta clientes a profissionais verificados de construção e reforma. Franca/SP.
- Criador de conteúdo de sim racing: canal @piloto.leal (#71), iRacing, foco em GT3.
- Trabalha com Claude Code, n8n, Notion, GitHub, Figma.
- Prefere respostas diretas e listas curtas. Português do Brasil.

## Como gosta de trabalhar
- Planejar antes de construir; checklist de produção em tudo.
