...
class Settings:
    ...
    spotify_token: __import__("pathlib").Path = field(default_factory=lambda: __import__("pathlib").Path(_env("SPOTIFY_TOKEN_FILE", "~/Jaime/spotify-token.json")).expanduser())
