...
| 1 | MCPs conectados | GitHub e Notion autenticados; maester-dev abre branch e commita |
| 2 | Agenda | scheduler próprio + Google Calendar (OAuth); maester-agenda lista e cria eventos |
