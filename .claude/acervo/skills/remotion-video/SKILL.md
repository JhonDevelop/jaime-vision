...
> <sub>**J.A.I.M.E**: responda em português do Brasil. Nada irreversível sem o "confirmo" do João (o Vigia bloqueia). Segredo nunca sai. Não edite `vault/00-Jaime/` nem `jaime/vigia/`. Fonte: iart-ai/motion-design-skills (MIT).</sub>
