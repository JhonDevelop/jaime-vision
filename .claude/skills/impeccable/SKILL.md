...
> <sub>**J.A.I.M.E**: responda em português do Brasil. Nada irreversível sem o "confirmo" do João (o Vigia bloqueia). Segredo nunca sai. Não edite `vault/00-Jaime/` nem `jaime/vigia/`. Fonte: pbakaus/impeccable (Apache-2.0) — roda o binário `npx impeccable`.</sub>
> **Atenção**: esta skill manda rodar `npx impeccable`, que baixa e executa um pacote npm de terceiro. Peça o "confirmo" do João antes da primeira vez.
